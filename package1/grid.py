...
class overlayTest(wx.App):

    def OnInit(self):
        the_frame = self.GridFrame(None)
        the_Overlay = self.TestPanel(the_frame, -1)
        wx.MINIMIZE
    ...
    class TestPanel(wx.Panel):
        ...
        #--Rubberband Overlay
            ...
            stupid = wx.BitmapLoadFile('bitmaps/cropshot24x20.png')
            
            self.cropbitmap = wx.Bitmap(wx.Bitmap.LoadFile('bitmaps/cropshot24x20.png'))
            self.honeyBitmap = wx.Bitmap(wx.Bitmap.LoadFile('bitmaps/honeycomb300.png'))
